...
- Polynomial multiplication in Z_{6984193}/(X^{1536}-1) with Good's trick
- Polynomial multiplication in Z_{4591}/(X^{1530}-1) with Rader's trick
- Polynomial multiplication in Z_{4591}/(X^{1620}-1) with mixed-radix
...
- ntrulpr761\_rader\_speed.bin: RADER macro activated NTRU Prime scheme
- sntrup761\_rader\_speed.bin: RADER macro activated Streamlined NTRU Prime scheme
...
- ntrulpr761\_rader\_stack.bin: RADER macro activated NTRU Prime scheme
- sntrup761\_rader\_stack.bin: RADER macro activated Streamlined NTRU Prime scheme
...
- ntrulpr761\_rader\_test.bin: RADER macro activated NTRU Prime scheme
- sntrup761\_rader\_test.bin: RADER macro activated Streamlined NTRU Prime scheme
